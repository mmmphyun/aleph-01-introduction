...
const POSITIONS = {
  ...
  fullback: [
    // 3) 오버래핑 상황: 완벽한 1자 3백(y:56), 수비-미드 사이 레지스타(y:46), LCM 전진 박스 지원, RB 오버래핑
    { x: 50.0, y: 84.0 }, // GK
    { x: 26.0, y: 56.0 }, // LB  -> [3백 좌측, 완벽한 1자 라인 y:56]
    { x: 48.0, y: 56.0 }, // LCB -> [3백 중앙, 완벽한 1자 라인 y:56]
    { x: 70.0, y: 56.0 }, // RCB -> [3백 우측, 완벽한 1자 라인 y:56]
    { x: 90.0, y: 10.0 }, // RB  -> [우측 코너 플래그 끝까지 오버래핑!]
    { x: 30.0, y: 24.0 }, // LCM -> [박스 전면 좌측으로 깊게 전진하여 2선 지원]
    { x: 52.0, y: 44.0 }, // Regista -> [수비라인(y:56)과 미드라인 사이 중앙에서 딥라잉 조율 & 겹침 완벽 해소!]
    { x: 74.0, y: 28.0 }, // CM  -> [오버래핑한 RB 대각선 뒤에서 리턴 연계 지원]
